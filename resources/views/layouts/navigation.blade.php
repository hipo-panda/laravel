...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" >
    ...
    <div  class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div style="height:5%;" class="flex justify-between h-16">
            <div style="width:15%;" class="flex">
                <!-- Logo -->
                <div style="width:120%" class="shrink-0 flex items-center">
                    <a href="/home">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div>
                    <a href="/recipeForm" class="recipe-button">레시피 작성</a>
                </div>
            </div>
